...
Shader "Brush"
{
	Properties
	{
		[HideInInspector][NoScaleOffset]_Normal1("Normal 1", 2D) = "bump" {}
		[HideInInspector][NoScaleOffset]_Normal2("Normal 2", 2D) = "bump" {}
		[HideInInspector][NoScaleOffset]_Normal3("Normal 3", 2D) = "bump" {}
		[HideInInspector][NoScaleOffset]_Normal4("Normal 4", 2D) = "bump" {}
		[NoScaleOffset]_Texture1("Texture 1", 2D) = "white" {}
		_Tilling1("Tilling 1", Float) = 2
		_IntensityNormal1("Intensity Normal 1", Range( 1 , 2)) = 0
		[NoScaleOffset]_Texture2("Texture 2", 2D) = "white" {}
		_Tilling2("Tilling 2", Float) = 2
		_IntensityNormal2("Intensity Normal 2", Range( 1 , 1.5)) = 0
		[NoScaleOffset]_Texture3("Texture 3", 2D) = "white" {}
		_Tilling3("Tilling 3", Float) = 2
		_IntensityNormal3("Intensity Normal 3", Range( 1 , 1.5)) = 1
		[NoScaleOffset]_Texture4("Texture 4", 2D) = "white" {}
		_Tilling4("Tilling 4", Float) = 2
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 lerpResult59 = lerp( UnpackScaleNormal( tex2D( _Normal1, uv_TexCoord17 ), _IntensityNormal1 ) , UnpackScaleNormal( tex2D( _Normal2, uv_TexCoord19 ), _IntensityNormal2 ) , Red61);
			float2 temp_cast_2 = (_Tilling3).xx;
			float2 uv_TexCoord22 = i.uv_texcoord * temp_cast_2;
			float Green62 = i.vertexColor.g;
			float3 lerpResult47 = lerp( lerpResult59 , UnpackScaleNormal( tex2D( _Normal3, uv_TexCoord22 ), _IntensityNormal3 ) , Green62);
			float2 temp_cast_3 = (_Tilling4).xx;
			float2 uv_TexCoord24 = i.uv_texcoord * temp_cast_3;
			float Blue60 = i.vertexColor.b;
			float3 lerpResult50 = lerp( lerpResult47 , UnpackScaleNormal( tex2D( _Normal4, uv_TexCoord24 ), _IntensityNormal4 ) , Blue60);
...
/*ASEBEGIN
Version=16700
1;488;964;511;2185.94;953.2712;2.040821;True;False
Node;AmplifyShaderEditor.VertexColorNode;2;-2574.948,-728.9564;Float;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;20;-2213.755,-1205.432;Float;False;Property;_Tilling2;Tilling 2;8;0;Create;True;0;0;False;0;2;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;18;-2251.887,-1605.893;Float;False;Property;_Tilling1;Tilling 1;5;0;Create;True;0;0;False;0;2;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;74;-2049.647,-1474.101;Float;False;Property;_IntensityNormal1;Intensity Normal 1;6;0;Create;True;0;0;False;0;0;0;1;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;73;-2098.565,-1065.666;Float;False;Property;_IntensityNormal2;Intensity Normal 2;9;0;Create;True;0;0;False;0;0;0;1;1.5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;57;-1752.859,-1138.163;Float;True;Property;_Normal2;Normal 2;1;2;[HideInInspector];[NoScaleOffset];Create;True;0;0;False;0;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;55;-1751.824,-1540.129;Float;True;Property;_Normal1;Normal 1;0;2;[HideInInspector];[NoScaleOffset];Create;True;0;0;False;0;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;21;-1731.898,-665.9513;Float;False;Property;_Tilling3;Tilling 3;11;0;Create;True;0;0;False;0;2;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;23;-1363.227,-157.6403;Float;False;Property;_Tilling4;Tilling 4;14;0;Create;True;0;0;False;0;2;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;66;-998.5569,-1091.07;Float;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SamplerNode;58;-1223.475,-630.9189;Float;True;Property;_Normal3;Normal 3;2;2;[HideInInspector];[NoScaleOffset];Create;True;0;0;False;0;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.WireNode;65;-1023.509,-1411.881;Float;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;72;-1166.827,-31.95463;Float;False;Property;_IntensityNormal4;Intensity Normal 4;15;0;Create;True;0;0;False;0;2;2;1;1.5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.WireNode;68;-554.5587,-644.887;Float;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SamplerNode;48;-859.2533,-113.8659;Float;True;Property;_Normal4;Normal 4;3;2;[HideInInspector];[NoScaleOffset];Create;True;0;0;False;0;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;70;-780.6473,-446.765;Float;False;60;Blue;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;69;-604.5918,-483.016;Float;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;-218.756,-351.337;Float;False;True;6;Float;ASEMaterialInspector;0;0;Standard;Brush;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;All;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;2;10;25;False;0.5;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=318DFC23D8D330F471ADAFCD938114009C4FB2F3